...
class TestAdminCRUD:
    ...
    def test_search_admin(self, admin_data, admin_login):
        ...
        # Arrange - Primeiro cria um administrador para buscar
        valid_data = admin_data["valid"]
        # Muda o email para evitar conflito com admin principal
        valid_data["email"] = "teste.busca@restel.com"
        self.admin_registration.register_admin(valid_data)
